...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if (Auth::user()->role == '1')
                        <div class="mb-3">
                            <a href="supplier-add" class="p-2 btn-sm btn-success">
                                <i class="uil uil-file-plus font-size-18 me-1"></i>Tambah Supplier
                            </a>
                        </div>
                    @endif
                                    ...
                                    <td>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                <a href="supplier-edit/{{ Crypt::encrypt($item->id) }}"
    ...
    @include('supplier.delete-supplier')
@endsection
@section('script')
