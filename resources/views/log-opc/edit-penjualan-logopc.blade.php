                ...
                <div class="card">
                    <div class="card-body">
                        @foreach ($penjualan as $item)
                            <form action="/logopc-penjualan-update/{{ Crypt::encrypt($item->id) }}" method="POST">
                                @csrf
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="Rp 0,00"
...
@section('script')
    ...
    <script>
        ...
        var tanggal = penjualan[0].tanggal,
            harga_def = penjualan[0].harga_vol_m3,
            total_harga_def = penjualan[0].total_harga;
        ...
        document.getElementById('harga').value = currency(harga_def);
        document.getElementById('total_harga').value = currency(total_harga_def);
