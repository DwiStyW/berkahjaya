    ...
    <div class="row">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        @foreach ($logopc as $item)
                            <form action="/logopc-stock-update/{{ Crypt::encrypt($item->id) }}" method="POST">
                                @csrf
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="0.1" id="uraian"
                                            name="uraian" value="{{ $item->uraian }}" oninput="Total()">
                                    </div>
                                </div>
                                <div class="mb-3 row">
...
@section('script')
    ...
    <script>
        function Total() {
            var vol = document.getElementById('uraian').value;
        ...
        var logopc = @json($logopc);
        console.log(logopc);
        var tanggal = logopc[0].tanggal,
            harga = logopc[0].harga;
