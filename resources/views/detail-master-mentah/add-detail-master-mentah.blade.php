    ...
    <div class="row">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="/detailmastermentah-store" method="POST">
                            @csrf
                            <input class="form-control" type="hidden" value="{{ $de_id }}" id="id_master"
                                name="id_master">
                            <div class="mb-3 row">
                                <label for="hasil_produksi" class="col-md-2 col-form-label">Kelas Model</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="text" placeholder="A-0" id="kelas_model"
                                        name="kelas_model">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="number" placeholder="10" id="model"
                                        name="model" oninput="hitungpakem()">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="hasil_produksi" class="col-md-2 col-form-label">Pakem</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="text" placeholder="0.00" id="pakem_pembulatan"
                                        name="pakem_pembulatan">
