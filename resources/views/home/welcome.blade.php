...
<head>
    ...
    <link href="{{ URL::asset('/assets/home/css/bootstrap.min.css') }}" rel="stylesheet">

    <link href="{{ URL::asset('/assets/home/css/bootstrap-icons.css') }}" rel="stylesheet">

    <link href="{{ URL::asset('/assets/home/css/templatemo-tiya-golf-club.css') }}" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <nav class="navbar navbar-expand-lg ">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="index.html">
                    <img src="{{ URL::asset('/assets/home/images/logo.png') }}" class="navbar-brand-image img-fluid"
                        alt="Tiya Golf Club">
        ...
        <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#d19054" fill-opacity="1"
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                        ...
                        <h1 class="cd-headline rotate-1 text-white mb-4 pb-2">
                            ...
                            <span class="cd-words-wrapper">
                                <b class="is-visible">Berkah Jaya</b>
                                <b>Berkah Jaya</b>
                                <b>Berkah Jaya</b>
                            </span>
                        </h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                        ...
                        <p><strong>Since 1984</strong>, Tiya is ranked #8 in the top 10 golf courses in the world. Tiya
                            is Bootstrap 5 HTML CSS template for golf clubs. Anyone can modify and use this layout for
                            commercial purposes.</p>

                        <p>Tiya Golf Club is 100% free CSS template provided by TemplateMo website. Please tell your
                            friends about our website. Thank you for visiting.</p>
                    </div>

                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                        <div class="member-block">
                            <div class="member-block-image-wrap">
                                <img src="{{ URL::asset('/assets/home/images/members/portrait-young-handsome-businessman-wearing-suit-standing-with-crossed-arms-with-isolated-studio-white-background.jpg') }}"
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="member-block">
                            <div class="member-block-image-wrap">
                                <img src="{{ URL::asset('/assets/home/images/members/successful-asian-lady-boss-red-blazer-holding-clipboard-with-documens-pen-working-looking-happy-white-background.jpg') }}"
                                    class="member-block-image img-fluid" alt="">
                ...
                <div class="row">
                        ...
                        <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="{{ URL::asset('/assets/home/images/professional-golf-player.jpg') }}"
                    ...
                    <div class="row custom-block custom-block-bg">
                        ...
                        <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="{{ URL::asset('/assets/home/images/girl-taking-selfie-with-friends-golf-field.jpg') }}"
                                        class="custom-block-image img-fluid" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="contact-info mt-5">
                            ...
                            <img src="{{ URL::asset('/assets/home/images/WorldMap.svg') }}" class="img-fluid"
                                alt="">
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="{{ URL::asset('/assets/home/images/logo.png') }}"
    ...
    <script src="{{ URL::asset('/assets/home/js/jquery.sticky.js') }}"></script>
    <script src="{{ URL::asset('/assets/home/js/click-scroll.js') }}"></script>
    <script src="{{ URL::asset('/assets/home/js/animated-headline.js') }}"></script>
    <script src="{{ URL::asset('/assets/home/js/modernizr.js') }}"></script>
